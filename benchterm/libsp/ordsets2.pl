...
ord_intersection2(U, [Set|Sets], Set0, Sets0) :- cti:{U=1},!,
	Set = Set0,
	Sets = Sets0.
ord_intersection2(D, [Set,Set2|Sets], Intersection, Sets0) :- cti:{D=2},!,
	Sets = Sets0,
...
ord_union_all(U, [Set|Sets], Set, Sets) :- cti:{U=1},!.
ord_union_all(D, [Set,Set2|Sets], Union, Sets) :- cti:{D=2},!,
